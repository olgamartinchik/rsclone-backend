...
const router = Router();
router.post('/register', [check('email', 'Incorrect email').isEmail(), check('password', 'Incorrect password').isLength({ min: 6 })], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
